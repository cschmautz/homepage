...
def load_json_file(json_file):
    """ JSON file loader.
        ...
        Args:
            json_file (json file) -- JSON file to load

        Returns:
            data (variant) -- result of loading JSON.
    """
...
def write_json_to_file(python_obj, output_path):
    """ Take a python object and output it into a JSON file format.
        ...
        Args:
            python_obj (object) -- a python object to convert to JSON.

            output_path (string) -- absolute path to write out the JSON py object.
    """
    ...
    with open(output_path, 'wb') as json_outf:
        if '2.7' in python_version:
            json_str = json.dumps(python_obj, json_outf,
            ...
            json_str = json.dumps(python_obj, json_outf, indent=2)
